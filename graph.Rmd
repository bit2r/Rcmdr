...
```{r graph-histogram-01, eval = FALSE}
...
```{r graph-histogram-02, eval = FALSE}
...
```{r graph-cowles-draw, eval = FALSE}
...
```{r graph-scatterplot-01, eval = FALSE}
...
```{r graph-scatterplot-02, eval = FALSE}
...
```{r graph-scatter-matrix, eval = FALSE}
...
```{r graph-means-plot-01, eval = FALSE}
...
```{r graph-means-plot-02, eval = FALSE}
...
```{r graph-means-plot-03, eval = FALSE}
