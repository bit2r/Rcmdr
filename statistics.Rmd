...
```{r proportion-one-02, eval = FALSE}
local({
...
```{r variance-ftest-01, eval = FALSE}
...
```{r variance-ftest-02, eval = FALSE}
...
```{r variance-bartlett, eval = FALSE}
...
```{r statistics-levene, eval = FALSE}
Tapply(prestige ~ type, var, na.action=na.omit, data=Prestige) # variances by group
...
```{r wilcocx-airquality, eval = FALSE}
...
```{r nonparametric-wilcoxon, eval = FALSE}
...
```{r paired-wilcoxon-01, eval = FALSE}
...
```{r friedman-dataset-testing, eval = FALSE}
local({
...
```{r friedman-dataset-testing-help, eval = FALSE}
...
```{r hcluster-summmary, eval = FALSE}
...
```{r dimension-reliability, eval = FALSE}
...
```{r linear-model-markdwon, eval = FALSE}
...
```{r glm-birthwt-glm-01, eval = FALSE}
