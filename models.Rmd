...
```{r select-active-model, eval = FALSE}
...
```{r model-summarize-01, eval = FALSE}
summary(LinearModel.2)
...
```{r model-summarize-02, eval = FALSE}
...
```{r model-testing-anova, eval = FALSE}
...
```{r model-graph-effect-01, eval = FALSE}
...
```{r model-graph-effect-02, eval = FALSE}
...
```{r model-graph-effect-03, eval = FALSE}
